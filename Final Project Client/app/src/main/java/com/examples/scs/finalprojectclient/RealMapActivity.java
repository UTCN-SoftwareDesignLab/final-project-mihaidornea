...
public class RealMapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void initMap(){
        ...
        mapFragment.getMapAsync(RealMapActivity.this);
    }
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()) {
                            ...
                            Toast.makeText(RealMapActivity.this, "Unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
